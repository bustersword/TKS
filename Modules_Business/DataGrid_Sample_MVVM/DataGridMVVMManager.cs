...
{
     [ModuleExport(typeof(DataGridMVVMManager))]
    public class DataGridMVVMManager:IModule
    {
         [Import("main")]
        ...
        [ImportingConstructor]
         public DataGridMVVMManager([Import]IRegionManager regionManager)
        {
        ...
        public void Initialize()
        {
            ...
            //模块初始化完后需要导航的，执行下面的方法，不需要导航的不执行
            DoNavigate(null);
        }
